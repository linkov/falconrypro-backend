...
ActiveRecord::Schema.define(version: 20170817195747) do
  ...
  add_index "diary_photos", ["bird_id"], name: "index_diary_photos_on_bird_id", using: :btree
  ...
  add_foreign_key "diary_photos", "birds"
